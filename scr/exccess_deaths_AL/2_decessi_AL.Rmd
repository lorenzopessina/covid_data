...
- Ogni grafico rappresenta il numero settimanale dei decessi registrati in ciascun cumune nelle prime 14 settimane dell'anno.
- La fonte dei dati é l'Istat, che li pubblica qui: **https://www.istat.it/it/archivio/240401**
- I dati sono aggiornati al 24 Aprile 2020.
...
# lista di citta
city_list <- c( "Alessandria", "Tortona",  "Novi Ligure", "Casale Monferrato", "Acqui Terme", "Ovada", "Valenza", "Arquata Scrivia", "Serravalle Scrivia", "Castelnuovo Scrivia", "Pozzolo Formigaro", "Castellazzo Bormida", "Gavi", "San Salvatore Monferrato")
